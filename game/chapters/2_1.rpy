label chapter_2_1:
    ...
    unknown "Michael, open the door."
    chloe "How does it know his name?"
    ethan "Maybe it heard us."
    unknown "Ethan?"
    ethan "Okay."
    ethan "I officialy hate this."
    narrator "The figure slowly turns toward me."
    unknown "[player_name]?"
    mc "..."
